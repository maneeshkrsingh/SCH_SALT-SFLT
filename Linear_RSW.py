...
ufile = VTKFile("CH_output0/RSW/velocity_output.pvd", project_output=True)
...
np.savetxt("CH_output0/RSW/energy_rsw.txt", energy_all)
np.save("CH_output0/RSW/energy.npy", energy_all)
# plt the energy
...
plt.legend()
plt.savefig("CH_output0/RSW/energy_plot.png")