...
mesh = PeriodicRectangleMesh(n, n,Lx, Ly,direction="x",
                                quadrilateral=True)
...
# u2_ic = -c * exp(-alpha_2 * abs(x - Ld/4))
# u3_ic = -c * exp(-alpha_3 * abs(x - Ld/4))



u10.interpolate(u1_ic) # initial condition 
u20.interpolate(0.0) # initial condition 
u30.interpolate(0.0) # initial condition 
...
T = 20.0
ufile_1 = VTKFile('../CH_output0/MultiCH/zeroanitpeakon/u1.pvd')
ufile_2 = VTKFile('../CH_output0/MultiCH/zeroanitpeakon/u2.pvd')
ufile_3 = VTKFile('../CH_output0/MultiCH/zeroanitpeakon/u3.pvd')
t = 0.0
