...
# 2. Function spaces
# --------------------------
V1 = fd.FunctionSpace(mesh, "BDM", 2)   # Velocity (H(div))
V2 = fd.FunctionSpace(mesh, "DG", 1)    # Depth (L2)
V = V1 *V1* V2
...
# u0.interpolate(u_expr)
# D_expr = 1  + (1/4*fd.pi)*(f/g)*fd.sin(4*fd.pi*y)
# D0.interpolate(D_expr)
...
Dfile = VTKFile("CH_output0/NLRSW/depth_output.pvd", project_output=True)
